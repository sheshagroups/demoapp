...
public class C4B_DSE_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c4_bdse_login);
        ...
        Intent home = new Intent(C4B_DSE_Login.this,C4B_Home.class);
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!validateStudentPass() | !validateStudentId()){
                    ...
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Class 4B");
        ...
        class_section.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.clear();
                editor.commit();
                Intent login = new Intent(C4B_DSE_Login.this, LoginPage.class);
                startActivity(login);
                finish();
            }
        });
