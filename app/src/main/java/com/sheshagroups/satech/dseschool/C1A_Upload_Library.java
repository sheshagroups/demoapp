...
public class C1A_Upload_Library extends AppCompatActivity {
    Button uploadcw;
    EditText uploadET;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c1_aupload_library);
        uploadcw = findViewById(R.id.uploadcw);
        upload = findViewById(R.id.upload);
        uploadET = findViewById(R.id.uploadET);
        FirebaseApp.initializeApp(C1A_Upload_Library.this);
        storageReference = FirebaseStorage.getInstance().getReference("C1A Library");
        databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded Library C1A");
    ...
    private void uploadPDFFile(Uri data){
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(C1A_Upload_Library.this,"File Uploaded",Toast.LENGTH_SHORT).show();
