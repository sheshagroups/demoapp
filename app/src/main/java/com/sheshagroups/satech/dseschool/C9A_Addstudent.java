...
public class C9A_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c9_aaddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 9A");
        ...
        Toast.makeText(C9A_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
