...
public class C11B_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c11_baddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 11B");
        ...
        Toast.makeText(C11B_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
