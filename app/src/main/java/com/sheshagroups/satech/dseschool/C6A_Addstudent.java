...
public class C6A_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c6_aaddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 6A");
        ...
        Toast.makeText(C6A_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
