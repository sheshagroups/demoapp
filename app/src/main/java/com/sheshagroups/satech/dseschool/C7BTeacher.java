...
public class C7BTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c7_bteacher);
        ...
        sharedPreferences=getSharedPreferences("login13",MODE_PRIVATE);
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                ...
                mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdDismissedFullScreenContent() {
                        ...
                        editor.clear();
                        editor.commit();
                        Intent cwpdf = new Intent(C7BTeacher.this,TeacherLogin.class);
                        startActivity(cwpdf);
                        finish();
                    }
        ...
        addstudent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(C7BTeacher.this,C7B_Addstudent.class);
        ...
        uploadcw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7BTeacher.this,C7B_UploadCW.class);
                startActivity(cwpdf);
            }
        });
        uploadhw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7BTeacher.this,C7B_UploadHW.class);
                startActivity(cwpdf);
            }
        });
        uploaddpp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7BTeacher.this,C7B_UploadDpp.class);
                startActivity(cwpdf);
            }
        });
        uploaddiary.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7BTeacher.this,C7B_UploadDiary.class);
                startActivity(cwpdf);
            }
        });
        addnotification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7BTeacher.this,C7B_AddNotification.class);
                startActivity(cwpdf);
            }
        });
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mInterstitialAd!=null){
                    mInterstitialAd.show(C7BTeacher.this);
                    SharedPreferences.Editor editor=sharedPreferences.edit();
                    editor.clear();
                    editor.commit();
                    Intent cwpdf = new Intent(C7BTeacher.this,TeacherLogin.class);
        ...
        updatestudent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7BTeacher.this,C7BStudentTeacherLogin.class);
                startActivity(cwpdf);
            }
        });
        application.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7BTeacher.this,Application_C7B.class);
                startActivity(cwpdf);
            }
        });
        library.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7BTeacher.this,C7B_Upload_Library.class);
                startActivity(cwpdf);
            }
   });
}
