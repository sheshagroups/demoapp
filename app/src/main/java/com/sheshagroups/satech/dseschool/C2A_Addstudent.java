...
public class C2A_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_aaddstudent);auth = FirebaseAuth.getInstance();
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 2A");
        ...
        Toast.makeText(C2A_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
