...
public class C6B_Upload_Application extends AppCompatActivity {
    Button uploadcw;
    EditText uploadET;
    ImageView upload;
    InterstitialAd mInterstitialAd;
    final private DatabaseReference databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded Application C6B");
    final private StorageReference storageReference = FirebaseStorage.getInstance().getReference("C6B Application");
    Uri imageUri;
    ProgressBar progress;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_c6_bupload_application);
                ...
                mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdDismissedFullScreenContent() {
                        ...
                        if (imageUri != null){
                            ...
                            Toast.makeText(C6B_Upload_Application.this, "Please Select Image", Toast.LENGTH_SHORT).show();
                        }
                ...
                new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(C6B_Upload_Application.this,"No Image Selected",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        uploadcw.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mInterstitialAd!=null){
                    mInterstitialAd.show(C6B_Upload_Application.this);
                    if (imageUri != null){
                        uploadToFirebase(imageUri);
                    }else{
                        Toast.makeText(C6B_Upload_Application.this, "Please Select Image", Toast.LENGTH_SHORT).show();
    ...
    private void uploadToFirebase(Uri uri){
        ...
        imageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                imageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(C6B_Upload_Application.this,"Uploaded",Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onFailure(@NonNull Exception e) {
                progress.setVisibility(View.INVISIBLE);
                Toast.makeText(C6B_Upload_Application.this, "Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
