...
public class C1A_EditStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c1_aedit_student);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back = new Intent(C1A_EditStudent.this, C1AStudentTeacherLogin.class);
                startActivity(back);
                finish();
            }
        });
