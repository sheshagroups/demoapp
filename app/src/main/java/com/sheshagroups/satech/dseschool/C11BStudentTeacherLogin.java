...
public class C11BStudentTeacherLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c11_bstudent_teacher_login);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(passwordFromDB.equals(studentpass)){
                        ...
                        Intent ihome = new Intent(C11BStudentTeacherLogin.this, C11B_EditStudent.class);
