...
public class C4A_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c4_aaddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 4A");
        ...
        Toast.makeText(C4A_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
