...
public class C4BStudentTeacherLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c4_bstudent_teacher_login);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(passwordFromDB.equals(studentpass)){
                        ...
                        Intent ihome = new Intent(C4BStudentTeacherLogin.this, C4B_EditStudent.class);
