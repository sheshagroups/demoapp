...
public class C3A_UploadDpp extends AppCompatActivity {
    Button uploadcw;
    EditText uploadET;
    ImageView upload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c3_aupload_dpp);
        uploadcw = findViewById(R.id.uploadcwc1b);
        upload = findViewById(R.id.uploadc1b);
        uploadET = findViewById(R.id.uploadETc1b);
        FirebaseApp.initializeApp(C3A_UploadDpp.this);
        storageReference = FirebaseStorage.getInstance().getReference("C3A DPP");
        databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded DPP C3A");
    ...
    private void uploadPDFFile(Uri data){
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(C3A_UploadDpp.this,"File Uploaded",Toast.LENGTH_SHORT).show();
