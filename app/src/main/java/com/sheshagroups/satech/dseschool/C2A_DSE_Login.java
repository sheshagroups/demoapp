...
public class C2A_DSE_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_adse_login);
        ...
        sharedPreferences=getSharedPreferences("login3",MODE_PRIVATE);
        sharedPreferences1=getSharedPreferences("student",MODE_PRIVATE);
        FirebaseApp.initializeApp(this);
        Intent home = new Intent(C2A_DSE_Login.this,C2A_Home.class);
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!validateStudentPass() | !validateStudentId()){
                    ...
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Class 2A");
        ...
        class_section.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.clear();
                editor.commit();
                Intent login = new Intent(C2A_DSE_Login.this, LoginPage.class);
                startActivity(login);
                finish();
            }
        });
