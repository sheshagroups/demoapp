...
public class C11B_UploadDpp extends AppCompatActivity {
    Button uploadcw;
    EditText uploadET;
    ImageView upload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c11_bupload_dpp);
        uploadcw = findViewById(R.id.uploadcwc1b);
        upload = findViewById(R.id.uploadc1b);
        uploadET = findViewById(R.id.uploadETc1b);
        FirebaseApp.initializeApp(C11B_UploadDpp.this);
        storageReference = FirebaseStorage.getInstance().getReference("C11B DPP");
        databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded DPP C11B");
    ...
    private void uploadPDFFile(Uri data){
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(C11B_UploadDpp.this,"File Uploaded",Toast.LENGTH_SHORT).show();
