...
public class C9B_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c9_baddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 9B");
        ...
        Toast.makeText(C9B_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
