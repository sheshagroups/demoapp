...
public class C8A_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c8_aaddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 8A");
        ...
        Toast.makeText(C8A_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
