...
public class C5B_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c5_baddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 5B");
        ...
        Toast.makeText(C5B_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
