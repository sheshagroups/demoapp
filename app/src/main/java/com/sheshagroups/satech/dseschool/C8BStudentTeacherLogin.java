...
public class C8BStudentTeacherLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c8_bstudent_teacher_login);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(passwordFromDB.equals(studentpass)){
                        ...
                        Intent ihome = new Intent(C8BStudentTeacherLogin.this, C8B_EditStudent.class);
