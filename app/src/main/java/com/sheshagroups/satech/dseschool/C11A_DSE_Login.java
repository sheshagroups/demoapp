...
public class C11A_DSE_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c11_adse_login);
        ...
        Intent home = new Intent(C11A_DSE_Login.this,C11A_Home.class);
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!validateStudentPass() | !validateStudentId()){
                    ...
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Class 11A");
        ...
        class_section.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.clear();
                editor.commit();
                Intent login = new Intent(C11A_DSE_Login.this, LoginPage.class);
                startActivity(login);
                finish();
            }
        });
