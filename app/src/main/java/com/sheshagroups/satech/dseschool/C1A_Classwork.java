...
public class C1A_Classwork extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c1_aclasswork);
    ...
    private void displayPdfs(){
        ...
        pRef = FirebaseDatabase.getInstance().getReference().child("Uploaded CW C1A");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(C1A_Classwork.this,":",Toast.LENGTH_SHORT).show();
                }
            }
