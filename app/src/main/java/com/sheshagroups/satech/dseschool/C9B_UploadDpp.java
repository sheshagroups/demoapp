...
public class C9B_UploadDpp extends AppCompatActivity {
    Button uploadcw;
    EditText uploadET;
    ImageView upload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c9_bupload_dpp);
        uploadcw = findViewById(R.id.uploadcwc1b);
        upload = findViewById(R.id.uploadc1b);
        uploadET = findViewById(R.id.uploadETc1b);
        FirebaseApp.initializeApp(C9B_UploadDpp.this);
        storageReference = FirebaseStorage.getInstance().getReference("C9B DPP");
        databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded DPP C9B");
    ...
    private void uploadPDFFile(Uri data){
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(C9B_UploadDpp.this,"File Uploaded",Toast.LENGTH_SHORT).show();
