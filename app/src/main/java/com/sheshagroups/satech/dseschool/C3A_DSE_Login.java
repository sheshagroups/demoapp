...
public class C3A_DSE_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c3_adse_login);
        ...
        sharedPreferences=getSharedPreferences("login5",MODE_PRIVATE);
        sharedPreferences1=getSharedPreferences("student",MODE_PRIVATE);
        FirebaseApp.initializeApp(this);
        Intent home = new Intent(C3A_DSE_Login.this,C3A_Home.class);
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!validateStudentPass() | !validateStudentId()){
                    ...
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Class 3A");
        ...
        class_section.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.clear();
                editor.commit();
                Intent login = new Intent(C3A_DSE_Login.this, LoginPage.class);
                startActivity(login);
                finish();
            }
        });
