...
public class C3A_Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c3_ahome);
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                ...
                mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdDismissedFullScreenContent() {
                        ...
                        editor.clear();
                        editor.commit();
                        Intent logout = new Intent(C3A_Home.this, LoginPage.class);
        ...
        student_cw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, C3A_Classwork.class);
                startActivity(cwpdf);
            }
        });
        student_hw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, C3A_Homework.class);
                startActivity(cwpdf);
            }
        });
        student_dpp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, C3A_DPP.class);
                startActivity(cwpdf);
            }
        });
        student_diary.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, C3A_Diary.class);
                startActivity(cwpdf);
            }
        });
        ...
        student_fees.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, C3A_Fees.class);
                startActivity(cwpdf);
            }
        });
        student_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, C3A_Notification.class);
                startActivity(cwpdf);
            }
        });
        ...
        student_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mInterstitialAd!=null){
                    mInterstitialAd.show(C3A_Home.this);
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.clear();
                    editor.commit();
                    Intent logout = new Intent(C3A_Home.this, LoginPage.class);
        ...
        aboutschool.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, AboutSchool.class);
                startActivity(cwpdf);
            }
        });
        ...
        contactus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, ContactUs.class);
                startActivity(cwpdf);
            }
        });
        ...
        library.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, C3A_Library.class);
                startActivity(cwpdf);
            }
        });
        application.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, C3A_Upload_Application.class);
                startActivity(cwpdf);
            }
        });
        imp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, Important.class);
                startActivity(cwpdf);
            }
        });
        pdf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C3A_Home.this, Document.class);
                startActivity(cwpdf);
            }
        });
    }
    public void showStudentData(){
        ...
        Intent profile = new Intent(C3A_Home.this,C3A_StudentDetail.class);
