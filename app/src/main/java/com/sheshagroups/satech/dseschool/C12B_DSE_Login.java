...
public class C12B_DSE_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c12_bdse_login);
        ...
        Intent home = new Intent(C12B_DSE_Login.this,C11C_Home.class);
        ...
        class_section.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.clear();
                editor.commit();
                Intent login = new Intent(C12B_DSE_Login.this, LoginPage.class);
                startActivity(login);
                finish();
            }
        });
