...
public class C1B_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c1_baddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 1B");
        ...
        Toast.makeText(C1B_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
