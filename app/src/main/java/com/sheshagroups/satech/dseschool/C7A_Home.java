...
public class C7A_Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c7_ahome);
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                ...
                mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdDismissedFullScreenContent() {
                        ...
                        editor.clear();
                        editor.commit();
                        Intent logout = new Intent(C7A_Home.this, LoginPage.class);
        ...
        student_cw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, C7A_Classwork.class);
                startActivity(cwpdf);
            }
        });
        student_hw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, C7A_Homework.class);
                startActivity(cwpdf);
            }
        });
        student_dpp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, C7A_DPP.class);
                startActivity(cwpdf);
            }
        });
        student_diary.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, C7A_Diary.class);
                startActivity(cwpdf);
            }
        });
        ...
        student_fees.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, C7A_Fees.class);
                startActivity(cwpdf);
            }
        });
        student_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, C7A_Notification.class);
                startActivity(cwpdf);
            }
        });
        ...
        student_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mInterstitialAd!=null){
                    mInterstitialAd.show(C7A_Home.this);
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.clear();
                    editor.commit();
                    Intent logout = new Intent(C7A_Home.this, LoginPage.class);
        ...
        aboutschool.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, AboutSchool.class);
                startActivity(cwpdf);
            }
        });
        ...
        contactus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, ContactUs.class);
                startActivity(cwpdf);
            }
        });
        ...
        library.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, C7A_Library.class);
                startActivity(cwpdf);
            }
        });
        application.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, C7A_Upload_Application.class);
                startActivity(cwpdf);
            }
        });
        imp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, Important.class);
                startActivity(cwpdf);
            }
        });
        pdf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cwpdf = new Intent(C7A_Home.this, Document.class);
                startActivity(cwpdf);
            }
        });
    }
    public void showStudentData(){
        ...
        Intent profile = new Intent(C7A_Home.this,C7A_StudentDetail.class);
