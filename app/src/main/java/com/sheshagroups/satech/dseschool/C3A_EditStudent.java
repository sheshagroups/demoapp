...
public class C3A_EditStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c3_aedit_student);name=findViewById(R.id.studentname);
        ...
        reference = FirebaseDatabase.getInstance().getReference("Class 3A");
        showAllData();
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(C3A_EditStudent.this,C3AStudentTeacherLogin.class);
                startActivity(back);
                finish();
            }
        });
