...
public class C6B_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c6_baddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 6B");
        ...
        Toast.makeText(C6B_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
