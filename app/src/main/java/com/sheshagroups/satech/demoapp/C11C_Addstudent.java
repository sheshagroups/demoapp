...
public class C11C_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c11_caddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 11C");
        ...
        Toast.makeText(C11C_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
