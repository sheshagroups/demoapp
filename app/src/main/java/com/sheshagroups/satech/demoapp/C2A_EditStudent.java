...
public class C2A_EditStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_aedit_student);
        ...
        reference = FirebaseDatabase.getInstance().getReference("Class 2A");
        showAllData();
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(C2A_EditStudent.this,C2AStudentTeacherLogin.class);
                startActivity(back);
                finish();
            }
        });
