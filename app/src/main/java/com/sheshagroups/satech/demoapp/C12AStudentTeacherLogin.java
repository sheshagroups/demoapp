...
public class C12AStudentTeacherLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c12_astudent_teacher_login);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(passwordFromDB.equals(studentpass)){
                        ...
                        Intent ihome = new Intent(C12AStudentTeacherLogin.this, C12A_EditStudent.class);
