...
public class C7A_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c7_aaddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 7A");
        ...
        Toast.makeText(C7A_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
