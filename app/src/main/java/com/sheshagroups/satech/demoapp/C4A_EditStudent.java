...
public class C4A_EditStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c4_aedit_student);
        ...
        reference = FirebaseDatabase.getInstance().getReference("Class 4A");
        showAllData();
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(C4A_EditStudent.this,C4AStudentTeacherLogin.class);
                startActivity(back);
                finish();
            }
        });
