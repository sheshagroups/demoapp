...
public class Upload_Doc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadcw = findViewById(R.id.uploadcw12);
        upload = findViewById(R.id.upload12);
        uploadET = findViewById(R.id.uploadET12);
        FirebaseApp.initializeApp(Upload_Doc.this);
        storageReference = FirebaseStorage.getInstance().getReference("Document");
        databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded Document");
    ...
    private void uploadPDFFile(Uri data){
        ...
        StorageReference reference = storageReference.child("Important PDF"+ UUID.randomUUID().toString()+".pdf");
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(Upload_Doc.this,"File Uploaded",Toast.LENGTH_SHORT).show();
