...
public class C5A_AddNotification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c5_aadd_notification);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(C5A_AddNotification.this, "Notification Added", Toast.LENGTH_SHORT).show();
            }
        });
    }
}