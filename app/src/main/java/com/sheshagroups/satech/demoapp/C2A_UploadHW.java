...
public class C2A_UploadHW extends AppCompatActivity {
    Button uploadcw;
    EditText uploadET;
    ImageView upload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_aupload_hw);uploadcw = findViewById(R.id.uploadcwc1b);
        upload = findViewById(R.id.uploadc1b);
        uploadET = findViewById(R.id.uploadETc1b);
        FirebaseApp.initializeApp(C2A_UploadHW.this);
        storageReference = FirebaseStorage.getInstance().getReference("C2A HW");
        databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded HW C2A");
    ...
    private void uploadPDFFile(Uri data){
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(C2A_UploadHW.this,"File Uploaded",Toast.LENGTH_SHORT).show();
