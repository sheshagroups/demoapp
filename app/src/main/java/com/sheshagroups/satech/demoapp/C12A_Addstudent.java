...
public class C12A_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c12_aaddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 12A");
        ...
        Toast.makeText(C12A_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
