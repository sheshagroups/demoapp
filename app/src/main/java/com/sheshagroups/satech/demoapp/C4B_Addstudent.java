...
public class C4B_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c4_baddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 4B");
        ...
        Toast.makeText(C4B_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
