...
public class C12B_UploadCW extends AppCompatActivity {
    Button uploadcw;
    EditText uploadET;
    ImageView upload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c12_bupload_cw);
        uploadcw = findViewById(R.id.uploadcwc1b);
        upload = findViewById(R.id.uploadc1b);
        uploadET = findViewById(R.id.uploadETc1b);
        FirebaseApp.initializeApp(C12B_UploadCW.this);
        storageReference = FirebaseStorage.getInstance().getReference("C12B CW");
        databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded CW C12B");
    ...
    private void uploadPDFFile(Uri data){
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(C12B_UploadCW.this,"File Uploaded",Toast.LENGTH_SHORT).show();
