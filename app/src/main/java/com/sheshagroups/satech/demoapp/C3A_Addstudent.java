...
public class C3A_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c3_aaddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 3A");
        ...
        Toast.makeText(C3A_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
