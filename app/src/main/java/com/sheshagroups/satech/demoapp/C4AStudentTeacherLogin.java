...
public class C4AStudentTeacherLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c4_astudent_teacher_login);
    ...
    public void checkStudent(){
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Class 4A");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(passwordFromDB.equals(studentpass)){
                        ...
                        Intent ihome = new Intent(C4AStudentTeacherLogin.this, C4A_EditStudent.class);
