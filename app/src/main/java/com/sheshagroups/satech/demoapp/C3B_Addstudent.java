...
public class C3B_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c3_baddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 3B");
        ...
        Toast.makeText(C3B_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
