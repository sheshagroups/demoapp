...
public class C10B_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c10_baddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 10B");
        ...
        Toast.makeText(C10B_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
