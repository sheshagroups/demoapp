...
public class C5B_Upload_Library extends AppCompatActivity {
    Button uploadcw;
    EditText uploadET;
    ImageView upload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c5_bupload_library);
        uploadcw = findViewById(R.id.uploadcw);
        upload = findViewById(R.id.upload);
        uploadET = findViewById(R.id.uploadET);
        FirebaseApp.initializeApp(C5B_Upload_Library.this);
        storageReference = FirebaseStorage.getInstance().getReference("C5B Library");
        databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded Library C5B");
    ...
    private void uploadPDFFile(Uri data){
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(C5B_Upload_Library.this,"File Uploaded",Toast.LENGTH_SHORT).show();
