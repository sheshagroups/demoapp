...
public class C7B_UploadHW extends AppCompatActivity {
    Button uploadcw;
    EditText uploadET;
    ImageView upload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c7_bupload_hw);
        uploadcw = findViewById(R.id.uploadcwc1b);
        upload = findViewById(R.id.uploadc1b);
        uploadET = findViewById(R.id.uploadETc1b);
        FirebaseApp.initializeApp(C7B_UploadHW.this);
        storageReference = FirebaseStorage.getInstance().getReference("C7B HW");
        databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded HW C7B");
    ...
    private void uploadPDFFile(Uri data){
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(C7B_UploadHW.this,"File Uploaded",Toast.LENGTH_SHORT).show();
