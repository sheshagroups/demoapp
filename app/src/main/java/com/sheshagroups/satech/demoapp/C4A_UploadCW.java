...
public class C4A_UploadCW extends AppCompatActivity {
    Button uploadcw;
    EditText uploadET;
    ImageView upload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c4_aupload_cw);
        uploadcw = findViewById(R.id.uploadcwc1b);
        upload = findViewById(R.id.uploadc1b);
        uploadET = findViewById(R.id.uploadETc1b);
        FirebaseApp.initializeApp(C4A_UploadCW.this);
        storageReference = FirebaseStorage.getInstance().getReference("C4A CW");
        databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded CW C4A");
    ...
    private void uploadPDFFile(Uri data){
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(C4A_UploadCW.this,"File Uploaded",Toast.LENGTH_SHORT).show();
