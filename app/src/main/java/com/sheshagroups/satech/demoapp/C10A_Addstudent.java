...
public class C10A_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c10_aaddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 10A");
        ...
        Toast.makeText(C10A_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
