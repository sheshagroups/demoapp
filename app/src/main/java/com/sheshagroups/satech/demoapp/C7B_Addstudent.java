...
public class C7B_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c7_baddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 7B");
        ...
        Toast.makeText(C7B_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
