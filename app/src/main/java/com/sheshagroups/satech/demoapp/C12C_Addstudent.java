...
public class C12C_Addstudent extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c12_caddstudent);
    ...
    public void addstudent(){
        ...
        reference = database.getReference("Class 12C");
        ...
        Toast.makeText(C12C_Addstudent.this,"Student Added",Toast.LENGTH_SHORT).show();
        empty();
