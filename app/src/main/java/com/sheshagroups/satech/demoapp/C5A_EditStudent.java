...
public class C5A_EditStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c5_aedit_student);
        ...
        reference = FirebaseDatabase.getInstance().getReference("Class 5A");
        showAllData();
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(C5A_EditStudent.this,C5AStudentTeacherLogin.class);
                startActivity(back);
                finish();
            }
        });
