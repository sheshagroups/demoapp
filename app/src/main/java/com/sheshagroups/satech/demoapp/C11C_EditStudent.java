...
public class C11C_EditStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c11_cedit_student);
        ...
        reference = FirebaseDatabase.getInstance().getReference("Class 11C");
        showAllData();
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(C11C_EditStudent.this,C11CStudentTeacherLogin.class);
                startActivity(back);
                finish();
            }
        });
