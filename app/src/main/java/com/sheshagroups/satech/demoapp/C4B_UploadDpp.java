...
public class C4B_UploadDpp extends AppCompatActivity {
    Button uploadcw;
    EditText uploadET;
    ImageView upload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(C4B_UploadDpp.this);
        storageReference = FirebaseStorage.getInstance().getReference("C4B DPP");
        databaseReference= FirebaseDatabase.getInstance().getReference("Uploaded DPP C4B");
    ...
    private void uploadPDFFile(Uri data){
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(C4B_UploadDpp.this,"File Uploaded",Toast.LENGTH_SHORT).show();
